namespace Sand.Cache
{
    ...
    /// </summary>
    public class MemoryCachingInterceptor : AbstractInterceptor
    {
        /// <summary>
        ...
        /// </summary>
        [FromContainer]
        public ILogger<MemoryCachingInterceptor> Logger { get; set; }
        ...
        {
            if (GetMethodAttributes(context.ServiceMethod).FirstOrDefault(x => typeof(MemoryCachingAttribute).IsAssignableFrom(x.GetType())) is MemoryCachingAttribute attribute)
            {
