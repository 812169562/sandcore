...
namespace Sand.Helpers {
    ...
    public static class Web {
        ...
        static Web() {
            try {
                HttpContextAccessor = DefaultIocConfig.Container.Resolve<IHttpContextAccessor>();
                Environment = DefaultIocConfig.Container.Resolve<IHostingEnvironment>();
            }
            catch{
            }
        }
        ...
        public static string Body
        {
            get
            {
                ...
                return SandFile.ToString(Request.Body, isCloseStream: false);
            }
        }
        ...
        {
            Request.EnableRewind();
            return await SandFile.ToStringAsync(Request.Body, isCloseStream: false);
        }
