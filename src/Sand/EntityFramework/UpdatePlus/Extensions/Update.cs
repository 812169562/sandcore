...
namespace Sand.EntityFramework.UpdatePlus
{
    ...
    public static partial class BatchUpdateExtensions
    {
        ...
        /// <param name="defaultFactory">The update expression.</param>
        /// <returns>The number of rows affected.</returns>
        public static int Update<T>(this IQueryable<T> query, Expression<Func<T, T>> updateFactory, Expression<Func<T, T>> defaultFactory = null) where T : class
        {
            return query.Update(updateFactory, defaultFactory, null);
        }
        ...
        /// <returns>The number of rows affected.</returns>
        public static int Update<T>(this IQueryable<T> query, Expression<Func<T, T>> updateFactory, Expression<Func<T, T>> defaultFactory, Action<BatchUpdate> batchUpdateBuilder) where T : class
        {
            ...
            return batchUpdate.Execute(query, updateFactory, defaultFactory);
        }
    }
}